...
<head>
    ...
    margin-bottom: 5px;
    border-radius: 5px;
    background: linear-gradient(to bottom, #343a40, #1d2124); /* Dark gradient background for dark button */
    color: #ffffff; /* Text color for the dark button */
    border: 1px solid #343a40; /* Border color for the dark button */
}

.btn-dark:hover {
    background: linear-gradient(to bottom, #1d2124, #0d1112); /* Dark gradient on hover for dark button */
    border-color: #1d2124; /* Border color on hover for dark button */
}
    ...
    <div class="container">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h3 class="m-0 font-weight-bold text-<?php echo $g[0]->color;?>">HRs</h3>
            </div>
            <div class="card-body">
